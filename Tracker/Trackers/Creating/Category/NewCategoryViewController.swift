...
final class NewCategoryViewController: UIViewController {
    ...
    private let textField: UITextField = {
        ...
        textField.placeholder = NSLocalizedString("textFieldNewCategory.placeholder", comment: "")
    ...
    private let doneButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("newCategoryDoneButton.setTitle", comment: ""), for: .normal)
